...
For each search:
- Use `WebSearch` with site-specific queries (linkedin.com/jobs, indeed.com, glassdoor.com, ziprecruiter.com, Google Jobs, company career pages, etc.)
- Target your configured geographic area (US city/state/metro, or "remote")
