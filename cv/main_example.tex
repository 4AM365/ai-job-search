...
%% Use as a master reference when tailoring role-specific resumes.
%%
...
% --- Most Recent Role ---
\item{\cventry{[YYYY--Present]}{[Job Title]}{[Company]}{[City, ST]}{}{\vspace{1pt}
\begin{itemize}
...
% --- Previous Role ---
\item{\cventry{[YYYY--YYYY]}{[Job Title]}{[Company]}{[City, ST]}{}{\vspace{1pt}
\begin{itemize}
...
\item{\cventry{[YYYY--YYYY]}{[Degree] in [Field]}{[Institution]}{[City, ST]}{}{\vspace{1pt}
...
% ============================================================
%     NOTE: US resumes omit a References section entirely.
%     Provide references on a separate sheet only if an employer asks.
% ============================================================
